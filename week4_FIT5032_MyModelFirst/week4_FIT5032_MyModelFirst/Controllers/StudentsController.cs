...
using week4_FIT5032_MyModelFirst.Models;

namespace week4_FIT5032_MyModelFirst.Controllers
{
    public class StudentsController : Controller
    {
        private week4_MyModelFirstContainer db = new week4_MyModelFirstContainer();
